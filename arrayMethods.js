...
// CODE HERE
const orderTotals = orders.map((price, tax) => {return price * (1 + tax)}, orders)
...
// CODE HERE
const bobsTotal = purchases.filter(purchases => purchases.owner === 'Bob').reduce((acc, purchases) => acc + purchases.price, 0)
